---
title: Fiddler Classic Migration
description: "Migrate from Fiddler Classic to Fiddler Everywhere by importing your settings, AutoResponder rules, and filters using the built-in import wizard."
slug: fe-migrating-from-classic
publish: true
position: 250
previous_url: /knowledge-base/importing-fiddler-classic-settings
---
...
Even before the EULA update, many users had already been migrating to Fiddler Everywhere for its cross-platform support, extended protocol coverage, and active development. To make that transition easier, Fiddler Everywhere includes a built-in import wizard for carrying over your existing settings, rules, and filters from Fiddler Classic. The following table compares the two products:
...
| Redirect a host to a different host/IP/port | Tools > HOSTS | [Host Remapping](slug://host-remapping) (**Tools** menu or status bar), with added per-mapping port and protocol override, and import from the OS hosts file |
| AI Assistant | No | Yes |
| MCP server | No | Yes |
...
![import configuration options](knowledge-base/images/import-options.png)
...
![AutoResponder rules in Fiddler Classic](knowledge-base/images/fc-autoresponder.png)
...
![filters in Fiddler Classic](knowledge-base/images/fc-filters.png)
...
![Quick filters in Fiddler Classic](knowledge-base/images/fc-quick-filters.png)
