...
| Redirect a host to a different host/IP/port | Tools > HOSTS | [Settings > Hosts (Host Remapping)](slug://settings-host-remapping), with added per-mapping port and protocol override, and import from the OS hosts file |
| AI Assistant | No | Yes |
| MCP server | No | Yes |
