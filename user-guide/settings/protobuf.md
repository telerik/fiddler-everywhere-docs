---
title: Protobuf
page_title: Protobuf - Settings | Fiddler Everywhere
...
- **Decode gRPC traffic via Server Reflection**&mdash;This option is always enabled in Fiddler Everywhere but will be used only if the server supports it. Additionally, you must ignore server certificate errors through the **HTTPS** > **Ignore server certificate errors** option if a TLS connection is used.
