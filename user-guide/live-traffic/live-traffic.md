...
Use the **Columns** submenu to select which column will be visible in the **Live Traffic** list. Refer to the [KB article "How to View Web Session Summary"]({%slug how-to-view-web-session-summary%}) for detailed information about each column type.
