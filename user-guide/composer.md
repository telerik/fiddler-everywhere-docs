...
- JavaScript&mdash;suitable for JavaScript/TypeScript code. Support the MIME types as described [here](https://mimesniff.spec.whatwg.org/#javascript-mime-type).
