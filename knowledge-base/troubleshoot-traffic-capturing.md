...
meta_title: Troubleshooting HTTPS Capturing on macOS | Fiddler Everywhere
...
1. Check the command output for a line related to the server certificate. Under it, the certificate will list the Fiddler URL (http://www.fiddler2.com).
    ...
    * Server certificate:
    *  subject: OU=Created by http://www.fiddler2.com; O=Progress Telerik Fiddler; CN=*.example.com
