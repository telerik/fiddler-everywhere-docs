...
page_title: Exclude Outlook and Teams Traffic from Proxy Capture | Fiddler Everywhere
...
publish: true
res_type: kb
previous_url: /knowledge-base/setup-fiddler-alongside-outlook, /knowledge-base/setup-fiddler-alongside-office365
---
...
- Close the Office 365 application (for example, **Microsoft Outlook**, **MS Teams**, and others). Make sure it is **not** running in the background. 
...
After completing the above steps, the traffic generated from Outlook will bypass the Fiddler proxy. The same approach can be applied to any other client application you would like to skip the Fiddler Everywhere proxy.
