...
![Fiddler Everywhere Requests section with collections and saved entries](./images/requests-list-all.png)
...
1. Enter a request name and select the collection (folder) in which the request saves. Alternatively, you can create a new collection by clicking the folder icon to the right.
    ![Dialog for entering a collection name and folder](./images/requests-enter-name-and-folder.png)
