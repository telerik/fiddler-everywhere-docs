...
![Creating "Set User-Agent Chrome Windows" rule](./images/adv-change-ua-chrome-windows.png)

Once the rule is created, enable the **Rules** tab, toggle the rule switch, and start capturing traffic.

![Activating the "Set User-Agent Chrome Windows" rule](./images/adv-change-ua-chrome-windows-active.png)
...
![Creating "Set User-Agent Chrome Mac" rule](./images/adv-change-ua-chrome-mac.png)

Once the rule is created, enable the **Rules** tab, toggle the rule switch, and start capturing traffic.

![Activating the "Set User-Agent Chrome Mac" rule](./images/adv-change-ua-chrome-mac-active.png)
