---
title: Block Cookies
meta_title: Block Cookies - Rules Presets | Fiddler Everywhere
description: "You can use Fiddler's rules to block cookies. Import and customize ready-to-use rule presets for common web tooling."
...
![Creating "Block Cookies" rule](./images/adv-tech-block-cookies.png)

Once the rule is created, enable the **Rules** tab, toggle the rule switch, and start capturing traffic.

![Activating the "Block Cookies" rule](./images/adv-tech-block-cookies-active-rule.png)
