...
description: "Marking JavaScript sessions and JSON files while using Fiddler's rules. Import and customize ready-to-use rule presets for visual traffic marking."
