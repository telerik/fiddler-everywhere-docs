...
description: "Creating a transparent mapping or redirect to a localhost location while using Fiddler's rules. Import and customize ready-to-use rule presets for traffic redirection."
