...
description: "Blocking HTTPS traffic from specific processes while using Fiddler's rules. Import and customize ready-to-use rule presets for traffic control."
...
![Creating "Block Traffic to Specific Processes" rule](./images/adv-block-specific-processes.png)
...
![Activating the "Block Traffic to Specific Processes" rule](./images/adv-block-specific-processes-active.png)
