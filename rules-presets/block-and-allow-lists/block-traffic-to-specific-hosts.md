...
meta_title: Block Specific Hosts - Rules Presets | Fiddler Everywhere
description: "Blocking HTTPS traffic to specific hosts while using Fiddler's rules. Import and customize ready-to-use rule presets for traffic control."
...
![Creating "Block Traffic to Specific Hosts" rule](./images/adv-block-specific-hosts.png)
...
![Activating the "Block Traffic to Specific Hosts" rule](./images/adv-block-specific-hosts-active.png)
